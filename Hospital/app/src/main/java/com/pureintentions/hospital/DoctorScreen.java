...
public class DoctorScreen extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        patientName=findViewById(R.id.editText);
    ...
    private  void  voiceRemark(){
                ...
                in.putExtra(RecognizerIntent.EXTRA_PROMPT,"Hey Speak Something");
                try {
    ...
    private void createPDFFile(String Path) {
        ...
        try {
            ...
            addNewItem(document,"PRESCRIPTION", Element.ALIGN_CENTER,titleFont);
            ...
            addNewItem(document,"Age:-"+Age,Element.ALIGN_LEFT,valeFont);
            addLineSeperator(document);

            addNewItem(document,"Height:-"+Height,Element.ALIGN_LEFT,valeFont);
            addLineSeperator(document);

            addNewItem(document,"Weight:-"+Weight,Element.ALIGN_LEFT,valeFont);
            addLineSeperator(document);

            addNewItem(document,"BP:-"+Bp,Element.ALIGN_LEFT,valeFont);
            addLineSeperator(document);

            addNewItem(document,"Date:-"+Date,Element.ALIGN_LEFT,valeFont);
            addLineSeperator(document);
           ...
           addLineSpace(document);
            ...
            addNewItemLeftAndCenterAndRight(document,"1:-"+Medicine1,""+finalSelection1,""+Day1,titleFont,valeMedFont,valeMedFont);
            addLineSeperator(document);

            addNewItemLeftAndCenterAndRight(document,"2:-"+Medicine2,""+finalSelection2,""+Day2,titleFont,valeMedFont,valeMedFont);
            addLineSeperator(document);

            addNewItemLeftAndCenterAndRight(document,"3:-"+Medicine3,""+finalSelection3,""+Day3,titleFont,valeMedFont,valeMedFont);
            addLineSeperator(document);
